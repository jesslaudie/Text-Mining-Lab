...
Below is a graph depicting the top 20 most prevalent words after removing stop words and the words "climate", "change", "global", and "warming". These additional words were removed because they are the focus of our investigation and we are looking for the sentiment around them.
...
Interestingly the NRC lexicon has a much different distribution of positive and negative sentiment with the positive exceeding the negative. However, negative emotions like anger, fear, and sadness are quite prevalent which is more aligned with the results from the bing lexicon.
